  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text("-Матрица симетричная\n",style: TextStyle(fontWeight: FontWeight.bold)),
        const Text("-Матрица положительно определенная\n",style: TextStyle(fontWeight: FontWeight.bold)),
        Text(equation.op1),
        Text(equation.op2),
        Text(equation.op3),
        const Text("Условия выполняются => можно использовать использовать метод Холецкого\n", style: TextStyle(fontWeight: FontWeight.bold)),
        Text(equation.Atext),
        Text(equation.Btext),
        const Text("A = L * L^T\n"),
        const Text("|l11  0     0 |\n|l21 l22   0 | = L\n|l31 l32 l33|\n"),
        Text("l11 = (a11)^0.5 = "+equation.L[0][0].toString()+"\n"),
        Text("l22 = (a22 - (l21)^0.5 )^0.5 = "+equation.L[1][1].toString()+"\n"),
        Text("l33 = (a33 - (l32)^0.5 - (l31)^0.5 )^0.5 = "+equation.L[2][2].toString()+"\n"),
        Text("l21 = a21/l11 = "+equation.L[1][0].toString()+"\n"),
        Text("l31 = a31/l11 = "+equation.L[1][0].toString()+"\n"),
        Text("l32 = (a32 - l31 * l21) / l22 = "+equation.L[1][0].toString()+"\n"),
